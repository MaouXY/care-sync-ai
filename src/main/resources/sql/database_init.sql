...
CREATE DATABASE care_sync_db
    ...
    OWNER = postgres
    ENCODING = 'UTF8'
    LC_COLLATE = 'Chinese (Simplified)_China.936'  -- Windows 简化版 locale 名称
...
CREATE TABLE child (
                       ...
                       ai_struct_info JSONB, -- AI结构化信息：情感趋势、核心需求等（示例见下文）
...
-- TODO GIN检索ai_struct_info

-- ai_struct_info扩展结构示例
-- {
--   "emotion_trend": ["孤独", "平静", "开心"],
--   "core_needs": ["故事陪伴", "学习辅导"],
--   "potential_problems": ["沟通较少"],
...
CREATE TABLE ai_chat_record (
                                ...
                                digi_session_id VARCHAR(50) NOT NULL, -- 👉 livetalking生成的数字人Session ID（关联实例），为null则为AI文本对话，非数字人视频对话！
...
CREATE INDEX idx_chat_digi_session ON ai_chat_record(digi_session_id); -- 👉 新增数字人Session索引
...
--   "measures_suggest": ["每周3次AI故事推送（数字人播报，偏好童话类）"],
...
CREATE TABLE ai_analysis_log (
                                 ...
                                 session_ids TEXT[], -- 本次分析涉及的会话ID列表（如{"session1","session2"}）
